...
type Connection struct {
	...
	mutex             sync.Mutex
	rawLog            func(format string, v ...interface{})
}

func NewConnection(ctx context.Context, serverURL string,
	...
	conn, _, hs, err := dialer.Dial(ctx, serverURL)
	if err != nil {
...
func (c *Connection) SetRawLog(l func(format string, args ...interface{})) {
	c.rawLog = l
}
